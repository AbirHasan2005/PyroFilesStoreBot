...
@Bot.on_message((filters.user(Config.BOT_OWNER) & filters.incoming) & ~filters.chat(Config.DB_CHANNEL) & ~filters.command('start','clear_batch','status','broadcast','ban_user','unban_user','banned_users'))
