...
@Bot.on_message((filters.document | filters.video | filters.audio | filters.incoming) & ~filters.chat(Config.DB_CHANNEL) & ~filters.command(['start','broadcast','clear_batch','ban_user']))
