...
@Bot.on_message(filters.private & filters.incoming & ~filters.chat(Config.DB_CHANNEL) & ~filters.command(['status','start','clear_batch','broadcast','ban_user','unban_user','banned_users']))
